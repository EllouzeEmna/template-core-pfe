...
public class DemandeModuleService {
    ...
    public DemandeModuleDTO save(DemandeModuleDTO demandeModuleDTO) {
     ...
     DemandeModuleDTO resultDTO = DemandeModuleFactory.demandeModuleToDemandeModuleDTO(dm,false);
     return resultDTO;
    }
    ...
    public DemandeModuleDTO findDemandeModuleDTO(DemandeModulePK dmpk) {
     ...
     DemandeModuleDTO dto = DemandeModuleFactory.demandeModuleToDemandeModuleDTO(dm,false);
     return dto;
    }
    ...
    public List<DemandeModuleDTO> findAllDTO() {
     ...
     return DemandeModuleFactory.demandeModuleToDemandeModuleDTOs(result,false);
    }
