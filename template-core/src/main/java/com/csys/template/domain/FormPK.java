...
public class FormPK implements Serializable {
    ...
    public FormPK(String module, String form, String control, String codeMenu) {
        this.module = module;
        this.form = form;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FormPK)) {
            return false;
        }
        FormPK other = (FormPK) object;
    ...
    public String toString() {
        return "com.csys.template.domain.FormPK[ module=" + module + ", form=" + form + ", control=" + control + ", codeMenu=" + codeMenu + " ]";
    }
