...
public class AccessFormUserPK implements Serializable {
    ...
    public AccessFormUserPK(String module, String user, String form, String control, String codeMenu) {
        this.module = module;
        this.user = user;
        this.form = form;
    ...
    public String toString() {
        return "com.csys.template.domain.AccessFormUserPK[ module=" + module + ", user=" + user + ", form=" + form + ", control=" + control + ", codeMenu=" + codeMenu + " ]";
    }
